...
#include <OpenSG/OSGWindowFields.h> // Parent type
#include <OpenSG/OSGCameraFields.h> // Camera type
#include <OpenSG/OSGNodeFields.h> // Root type
#include <OpenSG/OSGBackgroundFields.h> // Background type
#include <OpenSG/OSGForegroundFields.h> // Foregrounds type
#include <OpenSG/OSGUInt32Fields.h> // TravMask type
#include <OpenSG/OSGReal32Fields.h> // DrawTime type

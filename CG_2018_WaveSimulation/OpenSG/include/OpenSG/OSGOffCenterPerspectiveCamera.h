...
#include <OpenSG/OSGOffCenterPerspectiveCameraBase.h>
...
#include <OpenSG/OSGOffCenterPerspectiveCameraBase.inl>
#include <OpenSG/OSGOffCenterPerspectiveCamera.inl>

...
#include <OpenSG/OSGReal32Fields.h> // ZeroParallaxDistance type
#include <OpenSG/OSGReal32Fields.h> // Overlap type

#include <OpenSG/OSGShearedStereoCameraDecoratorFields.h>
